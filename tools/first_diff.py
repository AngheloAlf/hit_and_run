...
def firstDiffMain():
    ...
    parser.add_argument("-v", "--version", help="Which version should be processed", default="us_2003_07_10")
    ...
    BUILTROM = buildFolder / args.version / f"hit_and_run.{args.version}.rom"
    BUILTMAP = buildFolder / args.version / f"hit_and_run.{args.version}.map"
